...
import static net.solarnetwork.ocpp.v16.jakarta.FeatureProfile.LocalAuthListManagement;
import static net.solarnetwork.ocpp.v16.jakarta.FeatureProfile.Reservation;
import static net.solarnetwork.ocpp.v16.jakarta.FeatureProfile.SmartCharging;
...
public enum ConfigurationKey implements net.solarnetwork.ocpp.domain.ConfigurationKey {
	...
	/**
	 * Sampled {@link ocpp.v16.jakarta.cs.Measurand} values to be included in a
	 * {@literal MeterValues} message, every {@link #MeterValueSampleInterval}
	 * seconds. Where applicable, the {@link ocpp.v16.jakarta.cs.Measurand} is
	 * combined with the optional phase, for instance: {@literal Voltage.L1}.
	 */
	...
	/**
	 * Clock-aligned periodic {@link ocpp.v16.jakarta.cs.Measurand} values to be
	...
	/**
	 * Sampled {@link ocpp.v16.jakarta.cs.Measurand} values to be included in
	 * the {@literal TransactionData} element of {@literal StopTransaction}
