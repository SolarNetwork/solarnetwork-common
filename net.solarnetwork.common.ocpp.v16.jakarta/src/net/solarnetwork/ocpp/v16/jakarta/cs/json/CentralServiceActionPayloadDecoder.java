...
import ocpp.v16.jakarta.cs.CentralSystemService;
...
import ocpp.v16.jakarta.cs.ObjectFactory;
...
public class CentralServiceActionPayloadDecoder extends BaseActionPayloadDecoder {
	...
	public CentralServiceActionPayloadDecoder(ObjectMapper mapper) {
		super(mapper, ObjectFactory.class, "ocpp/v16/jakarta/cs/OCPP_CentralSystemService_1.6.wsdl",
