...
public final class CentralSystemUtils {
	...
	/**
	 * Get a {@link ocpp.v16.jakarta.cs.AuthorizationStatus} for an
	...
	public static ocpp.v16.jakarta.cs.AuthorizationStatus statusForStatus(AuthorizationStatus status) {
		switch (status) {
			case Accepted:
				return ocpp.v16.jakarta.cs.AuthorizationStatus.ACCEPTED;

			case Blocked:
				return ocpp.v16.jakarta.cs.AuthorizationStatus.BLOCKED;

			case ConcurrentTx:
				return ocpp.v16.jakarta.cs.AuthorizationStatus.CONCURRENT_TX;

			case Expired:
				return ocpp.v16.jakarta.cs.AuthorizationStatus.EXPIRED;

			default:
				return ocpp.v16.jakarta.cs.AuthorizationStatus.INVALID;
		}
	}

	/**
	 * Convert a {@link ocpp.v16.jakarta.cs.SampledValue} into a
	 * {@link SampledValue}.
	 *
	...
	/**
	 * Convert a {@link ocpp.v16.jakarta.cs.UnitOfMeasure} into a
	 * {@link UnitOfMeasure}.
	 *
	 * @param unit
	...
	public static UnitOfMeasure unit(ocpp.v16.jakarta.cs.UnitOfMeasure unit) {
		...
		if ( ocpp.v16.jakarta.cs.UnitOfMeasure.CELCIUS == unit ) {
	...
	/**
	 * Convert a {@link ocpp.v16.jakarta.cs.Phase} into a {@link Phase}.
	 *
	 * @param phase
	...
	/**
	 * Convert a {@link ocpp.v16.jakarta.cs.Measurand} into a {@link Measurand}.
	 *
	 * @param measurand
	...
	/**
	 * Convert a {@link ocpp.v16.jakarta.cs.Location} into a {@link Location}.
	 *
	 * @param location
	...
	/**
	 * Convert a {@link ocpp.v16.jakarta.cs.ReadingContext} into a
	 * {@link ReadingContext}.
	 *
	 * @param context
