...
public interface AuthorizationCredentialsProvider {
	 ...
	 *         {@link #getAuthorizationSigningDate()} date, or {@code null}
	 *         if {@link #getAuthorizationSecret()} should be used
	 * @see #getAuthorizationSigningDate()
	 */
	default byte @Nullable [] getAuthorizationSigningKey() {
		return null;
	}
	 ...
	 *         that is non-{@code null}
	 */
	default @Nullable Instant getAuthorizationSigningDate() {
		return null;
	}
