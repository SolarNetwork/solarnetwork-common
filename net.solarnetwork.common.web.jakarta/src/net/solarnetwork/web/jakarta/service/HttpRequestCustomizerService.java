...
package net.solarnetwork.web.jakarta.service;
...
public interface HttpRequestCustomizerService extends Identifiable {
	 ...
	 *         was modified directly or unchanged, or {@code null} to prevent
	 *         the request from happening at all
	 */
	HttpRequest customize(HttpRequest request, @Nullable ByteList body,
	 ...
	 */
	default HttpRequest customize(HttpRequest request, @Nullable ByteList body) {
	 ...
	 * @return the client HTTP request, ready to be executed
	 * @throws IllegalArgumentException
	 *         if {@code uri} or {@code method} are {@code null}, or the
	...
	default ClientHttpRequest apply(ClientHttpRequestFactory requestFactory, URI uri, HttpMethod method,
			@Nullable ByteList body, @Nullable Map<String, ?> parameters) throws IOException {
	 ...
	 * @return the client HTTP request, ready to be executed
	 * @throws IllegalArgumentException
	 *         if {@code request} is {@code null}, or the customized request
	 *         is changed and {@code requestFactory} is {@code null}
	 * @throws IOException
	 *         if any IO error occurs
	 * @since 1.1
	 */
