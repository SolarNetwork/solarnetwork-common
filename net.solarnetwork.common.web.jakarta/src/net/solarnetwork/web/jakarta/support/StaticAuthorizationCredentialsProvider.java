...
public class StaticAuthorizationCredentialsProvider implements AuthorizationCredentialsProvider {
	...
	private final @Nullable String authorizationSecret;
	private final byte @Nullable [] signingKey;
	private final @Nullable Instant signingDate;
	...
	public StaticAuthorizationCredentialsProvider(String authorizationId, String authorizationSecret) {
		super();
		this.authorizationId = requireNonNullArgument(authorizationId, "authorizationId");
		this.authorizationSecret = requireNonNullArgument(authorizationSecret, "authorizationSecret");
	...
	public StaticAuthorizationCredentialsProvider(String authorizationId, byte[] signingKey,
		...
		this.signingKey = requireNonNullArgument(signingKey, "signingKey");
		this.signingDate = requireNonNullArgument(signingDate, "signingDate");
		;
	}
	...
	@Override
	public @Nullable String getAuthorizationSecret() {
		return authorizationSecret;
	}

	@Override
	public byte @Nullable [] getAuthorizationSigningKey() {
		return signingKey;
	}

	@Override
	public @Nullable Instant getAuthorizationSigningDate() {
		return signingDate;
	}
