...
public class ChargingProfile extends BasicUuidEntity implements Differentiable<ChargingProfile> {
	 ...
	 *        the primary key
	 */
	public ChargingProfile(@Nullable UUID id) {
		this(id, Instant.now());
	}
	 ...
	 *        the created date
	 */
	public ChargingProfile(@Nullable UUID id, @Nullable Instant created) {
	 ...
	 *        {@code null} Ill
	 */
	public ChargingProfile(@Nullable UUID id, @Nullable Instant created, ChargingProfileInfo info) {
		super(id, created);
	 ...
	 *         the other
	 */
	public boolean isSameAs(@Nullable ChargingProfile other) {
		if ( other == null ) {
			return false;
		}
	...
	@Override
	public boolean differsFrom(@Nullable ChargingProfile other) {
	 ...
	 */
	public final ChargingProfileInfo getInfo() {
		return info;
	}
	 ...
	 */
	public final void setInfo(ChargingProfileInfo info) {
		this.info = requireNonNullArgument(info, "info");
