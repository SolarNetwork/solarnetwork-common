...
package net.solarnetwork.ocpp.v16.json;
...
import net.solarnetwork.ocpp.xml.support.JaxbUtils;
import net.solarnetwork.ocpp.xml.support.SchemaValidationHelper;
