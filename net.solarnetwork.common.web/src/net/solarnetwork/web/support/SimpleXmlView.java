 ...
 * {@link #setContentType(String)} (e.g. {@literal text/xml;charset=UTF-8}).</p>
 * 
...
public class SimpleXmlView extends AbstractView {
	...
	private void outputObject(Object o, String name, Writer out, 
			ViewResponseAugmentor augmentor) 
	throws IOException {
	...
	private void outputMap(Map<?, ?> map, String name, Writer out,
			ViewResponseAugmentor augmentor) 
	throws IOException {
	...
	throws IOException {
		if ( getPropertySerializerRegistrar() != null && bean != null ) {
			...
			Object o = getPropertySerializerRegistrar().serializeProperty(name, bean.getClass(), bean, bean);
			if ( o != bean ) {
				if ( o != null ) {
	...
	public void setClassNamesAllowedForNesting(
			Set<String> classNamesAllowedForNesting) {
