...
public class PrefixedMessageSourceTests {
	...
	public static void setupClass() {
		...
		a.setBasename("net.solarnetwork.support.test.message-source-A");
		messageSourceA = a;

		ResourceBundleMessageSource b = new ResourceBundleMessageSource();
		b.setBasename("net.solarnetwork.support.test.message-source-B");
		messageSourceB = b;

		ResourceBundleMessageSource p = new ResourceBundleMessageSource();
		p.setBasename("net.solarnetwork.support.test.message-source-P");
		messageSourceP = p;
	}
