...
import net.solarnetwork.codec.jackson.BigDecimalStringSerializer;
...
public class BigDecimalStringSerializerTests {
	...
	public void serialize() throws Exception {
		...
		then(result).as("Serialized BigDecimal as string").isEqualTo(String.format("\"%s\"", num));
	}
	...
	public void serializeWithoutSerializer() throws Exception {
		...
		BigDecimal d = new BigDecimal(num);
		String result = m.writeValueAsString(d);
		then(result).as("Serialized BigDecimal as number when not configured").isEqualTo(num);
	}
	...
	public void serializeUsingAnnotation() throws Exception {
		...
		then(result).as("Serialized BigDecimal field as string")
				.isEqualTo(String.format("{\"d\":\"%s\"}", num));
	}
}
