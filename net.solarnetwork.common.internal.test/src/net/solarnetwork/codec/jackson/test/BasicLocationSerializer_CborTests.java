...
import net.solarnetwork.codec.jackson.BasicLocationSerializer;
import net.solarnetwork.codec.jackson.CborUtils;
import net.solarnetwork.codec.jackson.test.BasicLocationSerializerTests.IdentityBasicLocation;
...
public class BasicLocationSerializer_CborTests {
	...
	public void serialize_ident_noId() throws IOException {
		...
		// THEN
		then(cbor).as("CBOR").containsExactly(objectArray(mapper.writeValueAsBytes(l)));
	}
}
