...
public class BasicInstructionSerializer_CborTests {
	...
	public void serialize_withComplexResultParams() throws Exception {
		...
		then(result).as("CBOR").containsExactly(expected);
	}
