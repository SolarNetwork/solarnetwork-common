...
import net.solarnetwork.codec.jackson.BasicDatumAuxiliaryRecordSerializer;
...
public class BasicDatumAuxiliaryRecordSerializerTests {
	...
	@Before
	public void setup() {
		mapper = JsonUtils.JSON_OBJECT_MAPPER.rebuild().addModule(JsonUtils.DATUM_MODULE).build();
	}
