...
public class BasicMqttTopicAliases implements MqttTopicAliases {
	...
	public BasicMqttTopicAliases(int maximumAliasCount, ConcurrentMap<String, Integer> topicAliases,
		...
		this.topicAliases = requireNonNullArgument(topicAliases, "topicAliases");
		this.aliasedTopics = requireNonNullArgument(aliasedTopics, "aliasedTopics");
		this.topicAliasProperties = requireNonNullArgument(topicAliasProperties, "topicAliasProperties");
	}
	...
	@Override
	public @Nullable String aliasedTopic(@Nullable String topic, Integer alias) {
