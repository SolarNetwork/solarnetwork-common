/* ==================================================================
 * ReconfigurableMqttConnection.java - 27/11/2019 11:41:02 am
 * 
...
/**
 * API for a reconfigurable MQTT connection.
 * 
 * @author matt
 * @version 1.0
 */
public interface ReconfigurableMqttConnection {
	 ...
	 * 
	 * @return a future that completes when the connection has been reconfigured
	 */
	Future<?> reconfigure();
