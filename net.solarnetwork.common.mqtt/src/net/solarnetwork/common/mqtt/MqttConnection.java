...
public interface MqttConnection extends Closeable {
	 ...
	 */
	Future<?> subscribe(String topic, MqttQos qosLevel, @Nullable MqttMessageHandler handler);
	 ...
	 *         acknowledged by the MQTT server
	 */
	Future<?> unsubscribe(String topic, @Nullable MqttMessageHandler handler);
	 ...
	 *        the handler
	 */
	void setMessageHandler(@Nullable MqttMessageHandler handler);
	 ...
	 *        the observer
	 */
	void setConnectionObserver(@Nullable MqttConnectionObserver observer);
