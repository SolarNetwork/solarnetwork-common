...
public class FileLock {
	 ...
	 * class loader. This is used to protect the code against using Java SE APIs
	 * on Java ME.
	 * 
	 * @param className
	...
	/**
	 * Creates an NIO FileLock on the specified file if on a suitable Java
	 * runtime.
	 * 
	 * @param clientDir
	 *        the a File of the directory to contain the lock file.
	 * @param lockFilename
	 *        name of the the file to lock
	 * @throws Exception
	...
	public FileLock(File clientDir, String lockFilename) throws Exception {
		...
		if ( isClassAvailable("java.nio.channels.FileLock") ) {
			try {
