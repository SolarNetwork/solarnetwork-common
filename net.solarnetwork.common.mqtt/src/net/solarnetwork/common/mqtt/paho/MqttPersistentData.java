...
public class MqttPersistentData implements MqttPersistable {
	 ...
	 * used by the client to identify the persisted data to which further update
	 * or deletion requests are targeted.<BR>
	 ...
	 * 
	 * @param key
	 *        The key which identifies this data
	 * @param header
	 *        The message header
	 * @param hOffset
	 *        The start offset of the header bytes in header.
	 * @param hLength
	 *        The length of the header in the header bytes array.
	 * @param payload
	 *        The message payload
	 * @param pOffset
	 *        The start offset of the payload bytes in payload.
	 * @param pLength
	 *        The length of the payload in the payload bytes array when
	 *        persisting the message.
	 */
	public MqttPersistentData(String key, byte[] header, int hOffset, int hLength, byte[] payload,
