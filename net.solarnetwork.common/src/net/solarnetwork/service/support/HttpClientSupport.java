...
public class HttpClientSupport {
	 ...
	 */
	protected URLConnection getURLConnection(String url, @Nullable String httpMethod)
			throws IOException {
	 ...
	 */
	protected URLConnection getURLConnection(String url, @Nullable String httpMethod,
			@Nullable String accept) throws IOException {
	 ...
	 */
	protected String xWWWFormURLEncoded(@Nullable Map<String, ?> data) {
	 ...
	 */
	protected URLConnection postXWWWFormURLEncodedData(String url, @Nullable String accept,
			@Nullable Map<String, ?> data) throws IOException {
	 ...
	 */
	protected String postXWWWFormURLEncodedDataForString(String url, @Nullable Map<String, ?> data)
			throws IOException {
	...
	private @Nullable SSLService sslService() {
	 ...
	 * @return the service
	 */
	public @Nullable OptionalService<SSLService> getSslService() {
		return sslService;
	}
	 ...
	 *        the service to set
	 */
	public void setSslService(@Nullable OptionalService<SSLService> sslService) {
