...
public class BasicIdentifiable implements Identifiable {
	...
	private KeyValuePair @Nullable [] metadata;
	 ...
	 * @since 1.1
	 */
	public static List<SettingSpecifier> basicIdentifiableSettings(@Nullable String prefix) {
	 ...
	 * @since 2.1
	 */
	public static List<SettingSpecifier> basicIdentifiableMetadataSettings(@Nullable String prefix,
			KeyValuePair @Nullable [] metadata) {
		if ( prefix == null ) {
			prefix = "";
		}
		...
		return singletonList(SettingUtils.dynamicListSettingSpecifier(prefix + "metadata", exprConfsList,
				new SettingUtils.KeyedListCallback<KeyValuePair>() {
					...
					@Override
					public Collection<SettingSpecifier> mapListSettingKey(@Nullable KeyValuePair value,
	 ...
	 * @since 2.1
	 */
	public @Nullable String metadataValue(@Nullable String key) {
		if ( key == null ) {
			return null;
		}
	 ...
	 * @since 2.1
	 */
	public @Nullable Object smartMetadataValue(@Nullable String key) {
	 ...
	 * @since 2.1
	 */
	public @Nullable Number numberMetadataValue(@Nullable String key) {
	 ...
	 * @since 2.1
	 */
	public @Nullable Integer integerMetadataValue(@Nullable String key) {
		Object val = smartMetadataValue(key);
	 ...
	 * @since 2.1
	 */
	public @Nullable Double doubleMetadataValue(@Nullable String key) {
		Object val = smartMetadataValue(key);
	 ...
	 * @since 2.1
	 */
	public void saveMetadataValue(@Nullable String key, @Nullable Object value, boolean create) {
		if ( key == null ) {
			return;
		}
	 ...
	 * @since 2.1
	 */
	public void saveMetadataValue(int index, String key, @Nullable Object value, boolean create) {
		if ( index < 0 ) {
	 ...
	 * @since 2.1
	 */
	public KeyValuePair @Nullable [] getMetadata() {
		return metadata;
	}
	 ...
	 * @since 2.1
	 */
	public void setMetadata(KeyValuePair @Nullable [] metadata) {
	...
	public int getMetadataCount() {
		final KeyValuePair @Nullable [] vals = getMetadata();
