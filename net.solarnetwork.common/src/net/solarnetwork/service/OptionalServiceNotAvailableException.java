/* ==================================================================
 * OptionalServiceNotAvailableException.java - 24/09/2021 2:28:29 PM
 *
...
public class OptionalServiceNotAvailableException extends RuntimeException {
	 ...
	 *        the cause
	 */
	public OptionalServiceNotAvailableException(@Nullable Throwable cause) {
		super(cause);
	}
	 ...
	 *        the cause
	 */
	public OptionalServiceNotAvailableException(String message, @Nullable Throwable cause) {
		super(message, cause);
	}
