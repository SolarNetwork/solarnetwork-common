...
public interface DatumFilterService extends Identifiable {
	 ...
	 *
	 * <p>
	 * This method may also return {@code null} to indicate the {@code samples}
	 * instance should not be processed, or that there is essentially no data to
	 * associate with this particular {@code datum}.
	 * </p>
	 *
	 * @param datum
