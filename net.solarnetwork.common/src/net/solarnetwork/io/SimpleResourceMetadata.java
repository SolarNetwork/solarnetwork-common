...
public class SimpleResourceMetadata implements ResourceMetadata {
	 ...
	 *        the modified date
	 */
	public SimpleResourceMetadata(@Nullable Date modified) {
	 ...
	 *        the content type
	 */
	public SimpleResourceMetadata(@Nullable Date modified, @Nullable MimeType contentType) {
	 ...
	 */
	public final @Nullable Map<String, Object> getExtendedMetadata() {
	 ...
	 */
	public final void putExtendedMetadata(@Nullable Map<String, ?> extendedMetadata) {
