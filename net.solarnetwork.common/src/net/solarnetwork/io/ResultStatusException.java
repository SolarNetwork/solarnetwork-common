...
public class ResultStatusException extends RuntimeException {
	 ...
	 *        the message
	 */
	public ResultStatusException(@Nullable URL url, int statusCode, String message) {
		super(message);
		this.url = url;
	 ...
	 *        the cause
	 */
	public ResultStatusException(@Nullable URL url, int statusCode, String message, Throwable cause) {
		super(message, cause);
		this.url = url;
		this.statusCode = statusCode;
	}
