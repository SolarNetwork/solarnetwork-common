 ...
 * @since 4.13
 */
public class BasicInstructionDeserializer extends StdDeserializer<Instruction> {

	/** A default instance . */
	public static final ValueDeserializer<Instruction> INSTANCE = new BasicInstructionDeserializer();
