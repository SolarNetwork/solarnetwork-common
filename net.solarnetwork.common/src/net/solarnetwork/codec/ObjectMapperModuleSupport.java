...
public class ObjectMapperModuleSupport extends SimpleObjectMapperService {
	...
	private @Nullable List<JsonSerializer<?>> serializers;
	private @Nullable List<JsonDeserializer<?>> deserializers;
	private @Nullable List<TypedKeyDeserializer> keyDeserializers;
	private @Nullable List<JsonSerializer<?>> keySerializers;
	 ...
	 */
	public @Nullable List<JsonSerializer<?>> getSerializers() {
		return serializers;
	}
	 ...
	 *        the serializers
	 */
	public void setSerializers(@Nullable List<JsonSerializer<?>> serializers) {
	 ...
	 */
	public @Nullable List<JsonDeserializer<?>> getDeserializers() {
	 ...
	 *        the deserializers
	 */
	public void setDeserializers(@Nullable List<JsonDeserializer<?>> deserializers) {
	 ...
	 */
	public @Nullable List<TypedKeyDeserializer> getKeyDeserializers() {
	 ...
	 */
	public void setKeyDeserializers(@Nullable List<TypedKeyDeserializer> keyDeserializers) {
	 ...
	 * @return the serializers
	 */
	public @Nullable List<JsonSerializer<?>> getKeySerializers() {
	 ...
	 */
	public void setKeySerializers(@Nullable List<JsonSerializer<?>> keySerializers) {
