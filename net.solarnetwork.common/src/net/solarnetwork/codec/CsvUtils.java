...
public final class CsvUtils {
	 ...
	 *         column 27, and so on
	 */
	public static int parseColumnReference(final String ref) {
		if ( ref == null ) {
	 ...
	 * @return the column numbers as a set, or {@code null} if {@code value}
	 *         is {@code null} or empty or has no valid references
	 */
	public static @Nullable IntRangeSet parseColumnsReference(final @Nullable String value) {
