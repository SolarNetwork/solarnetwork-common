...
public class BasicTextAreaSettingSpecifier extends BaseKeyedSettingSpecifier<String>
	 ...
	 *        the default value
	 */
	public BasicTextAreaSettingSpecifier(String key, @Nullable String defaultValue) {
	 ...
	 * @since 1.1
	 */
	public BasicTextAreaSettingSpecifier(String key, @Nullable String defaultValue, boolean direct) {
		super(key, defaultValue);
		setDirect(direct);
	}
