...
public class BasicTitleSettingSpecifier extends BaseKeyedSettingSpecifier<String>
	...
	private @Nullable Map<String, String> valueTitles;
	 ...
	 *        the default value
	 */
	public BasicTitleSettingSpecifier(String key, @Nullable String defaultValue) {
	...
	@Override
	public @Nullable Map<String, String> getValueTitles() {
	 ...
	 *        the values to set
	 */
	public void setValueTitles(@Nullable Map<String, String> valueTitles) {
