...
public class BasicParentSettingSpecifier extends BaseSettingSpecifier implements ParentSettingSpecifier {
	 ...
	 *        the settings to set
	 */
	public void setChildSettings(@Nullable List<SettingSpecifier> childSettings) {
		this.childSettings = (childSettings != null ? Collections.unmodifiableList(childSettings)
