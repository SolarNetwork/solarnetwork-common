...
public abstract class BaseKeyedSettingSpecifier<T> extends BaseSettingSpecifier
	...
	private Object @Nullable [] descriptionArguments;
	 ...
	 *        the default value
	 */
	public BaseKeyedSettingSpecifier(String key, @Nullable T defaultValue) {
	 ...
	 */
	public BaseKeyedSettingSpecifier(String key, @Nullable T defaultValue, boolean trans) {
		super();
		setKey(key);
	 ...
	 */
	public final void setDefaultValue(@Nullable T defaultValue) {
	 ...
	 * @since 1.2
	 */
	public final void setDescriptionArguments(Object @Nullable [] descriptionArguments) {
		this.descriptionArguments = descriptionArguments;
	}

	@Override
	public final Object @Nullable [] getDescriptionArguments() {
