...
public interface MappableSpecifier {
	 ...
	 * @return the mapped settings, or {@code settings} if {@code settings} or
	 *         {@code prefix} is {@code null} or {@code prefix} is empty
	 * @since 1.1
	 */
	static @Nullable List<SettingSpecifier> mapTo(@Nullable List<SettingSpecifier> settings,
	 ...
	 * @since 1.1
	 */
	static @Nullable List<SettingSpecifier> mapWithPlaceholder(@Nullable List<SettingSpecifier> settings,
	 ...
	 * @since 1.1
	 */
	static @Nullable List<SettingSpecifier> mapWithMapper(@Nullable List<SettingSpecifier> settings,
