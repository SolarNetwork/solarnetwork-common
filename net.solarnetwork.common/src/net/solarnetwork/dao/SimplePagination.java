/* ==================================================================
 * SimplePagination.java - 2 Aug 2026 10:36:27 am
 *
...
/**
 * Simple, mutable implementation of {@link PaginationCriteria}.
 *
 * @author matt
 * @version 1.0
 * @since 4.49
 */
public class SimplePagination implements Cloneable, PaginationCriteria {
	 ...
	 * @since 1.2
	 */
	public boolean matches(@Nullable List<MutableSortDescriptor> sorts, @Nullable Long offset,
	 ...
	 */
	@Override
	public @Nullable List<MutableSortDescriptor> getSorts() {
		return sorts;
	}
	 ...
	 *        the sorts to set
	 */
	public void setSorts(@Nullable List<MutableSortDescriptor> sorts) {
		this.sorts = sorts;
	}
