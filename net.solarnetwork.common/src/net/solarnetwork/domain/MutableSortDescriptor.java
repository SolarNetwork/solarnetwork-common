...
public class MutableSortDescriptor implements SortDescriptor {
	 ...
	 *        the sort key
	 */
	public MutableSortDescriptor(@Nullable String sortKey) {
		this(sortKey, false);
	}
	 ...
	 *        ascending
	 */
	public MutableSortDescriptor(@Nullable String sortKey, boolean descending) {
		super();
	...
	public boolean equals(@Nullable Object obj) {
		...
		if ( !(obj instanceof MutableSortDescriptor other) ) {
			return false;
		}
