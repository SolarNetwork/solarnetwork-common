...
public interface Differentiable<T> {
	 ...
	 */
	boolean differsFrom(@Nullable T other);
	 ...
	 * @since 1.1
	 */
	static <T extends Differentiable<T>> boolean differ(@Nullable T l, @Nullable T r) {
		if ( l == r ) {
			return false;
	 ...
	 * @since 1.1
	 */
	static <T extends Differentiable<T>> boolean differ(@Nullable Collection<T> l,
			@Nullable Collection<T> r) {
		if ( l == r ) {
			return false;
		} else if ( l == null || r == null ) {
			return true;
