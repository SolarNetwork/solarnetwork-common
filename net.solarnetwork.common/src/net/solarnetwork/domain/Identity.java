 ...
 * @since 1.43
 */
public interface Identity<PK extends Comparable<PK>> extends Comparable<Identity<PK>> {
	 ...
	 */
	@Override
	default int compareTo(Identity<PK> o) {
		final PK id = getId();
		final PK otherId = (o != null ? o.getId() : null);
