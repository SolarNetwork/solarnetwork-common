...
public class BasicObjectDatumStreamDataSet<T extends StreamDatum>
	...
	private final @Nullable Long totalResultCount;
	private final @Nullable Integer returnedResultCount;
	private final @Nullable Integer startingOffset;
	...
	public static final <T extends StreamDatum> BasicObjectDatumStreamDataSet<T> dataSet(
			...
			@Nullable Integer returnedResultCount) {
	...
	@Override
	public @Nullable Long getTotalResultCount() {
		return totalResultCount;
	}

	@Override
	public @Nullable Integer getStartingOffset() {
		return startingOffset;
	}

	@Override
	public @Nullable Integer getReturnedResultCount() {
