...
public interface DayDatum extends AtmosphericDatum {
	 ...
	 */
	default @Nullable String getBriefOverview() {
	 ...
	 * @return the sunrise
	 */
	default @Nullable LocalTime getSunriseTime() {
	 ...
	 * @return the sunset
	 */
	default @Nullable LocalTime getSunsetTime() {
	 ...
	 */
	default @Nullable LocalTime getMoonriseTime() {
	 ...
	 * @return the moon set
	 */
	default @Nullable LocalTime getMoonsetTime() {
	 ...
	 */
	default @Nullable BigDecimal getTemperatureMinimum() {
	 ...
	 * @return the maximum temperature.
	 */
	default @Nullable BigDecimal getTemperatureMaximum() {
