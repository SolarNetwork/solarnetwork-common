...
public interface AcEnergyDatum extends EnergyDatum {
	 ...
	 */
	default @Nullable AcPhase getAcPhase() {
	 ...
	 */
	default @Nullable Float getEffectivePowerFactor() {
	 ...
	 * @return the phase
	 */
	default @Nullable Float getCurrent(AcPhase phase) {
	 ...
	 */
	default @Nullable Float getLineVoltage() {
	 ...
	 * @return the line voltage
	 */
	default @Nullable Float getLineVoltage(AcPhase phase) {
