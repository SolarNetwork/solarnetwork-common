...
public class SimpleTariff implements Tariff {
	...
	public SimpleTariff(Map<String, Rate> rates) {
		super();
		this.rates = requireNonNullArgument(rates, "rates");
	}
	...
	public SimpleTariff(Iterable<Rate> rates) {
		this(Collections.unmodifiableMap(StreamSupport
				.stream(requireNonNullArgument(rates, "rates").spliterator(), false).collect(Collectors
