...
public interface AppEvent {
	 ...
	 * @return the associated property value, or {@code null} if not available
	 */
	default @Nullable Object getProperty(String key) {
		Map<String, ?> props = getEventProperties();
	 ...
	 *        the property type
	 * @return the associated property value, or {@code null} if not available
	 *         or not of type {@code T}
	 */
	default <T> @Nullable T getProperty(String key, Class<T> type) {
