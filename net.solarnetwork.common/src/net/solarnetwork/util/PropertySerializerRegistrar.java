...
/**
 * A registrar of {@link PropertySerializer} implementations mapped to
 * specific object types or property names.
 * 
 * <p>The configurable properties of this class are:</p>
 * 
 * <dl class="class-properties">
 *   <dt>propertySerializers</dt>
 *   <dd>A property name mapping to {@link PropertySerializer} implementations
 *   for serializing those properties with.</dd>
 *   
 *   <dt>classSerializers</dt>
 *   <dd>A property type mapping to {@link PropertySerializer} implementations
 *   for serializing those properties with.</dd>
 * </dl>
 *
 * @author matt
...
public class PropertySerializerRegistrar {
	...
	/**
	 * Return a configured {@link PropertySerializer} for either a specific property
	 * name or property type.
	 * 
	 * <p>The {@code propertySerializers} mappings are consulted first (using the 
	 ...
	 * {@code propertyType} value). If no match is found, <em>null</em> is returned.</p>
	 * 
	 * @param propertyName the name of the property to serialize
	 * @param propertyType the type of property to serialize
	...
	/**
	 * Attempt to serialize a property using a configured {@link PropertySerializer},
	 * returning {@code propertyValue} if no matching serializer configured.
	 * 
	 * <p>This method calls {@link #serializerFor(String, Class)}, and if that returns
	 * a {@link PropertySerializer} the {@code bean}, {@code propertyName}, and 
	 * {@code propertyValue} will be passed to 
	 * {@link PropertySerializer#serialize(Object, String, Object)} and the result
	 * of that returned from this method.</p>
	 * 
	 * <p>If no matching serializer is found, {@code propertyValue} is returned
	 * unchanged.</p>
	 * 
	 * @param propertyName the name of the property being serialized
	 * @param propertyType the type of property being serialized
	 * @param bean the object the property is being serialized from
	...
	/**
	 * @param propertySerializers the propertySerializers to set
	 */
	public void setPropertySerializers(
	...
	/**
	 * @param classSerializers the classSerializers to set
	 */
	public void setClassSerializers(
			Map<String, PropertySerializer> classSerializers) {
