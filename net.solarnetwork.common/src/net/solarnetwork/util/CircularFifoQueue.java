...
public class CircularFifoQueue<E> extends AbstractCollection<E> implements Queue<E>, Serializable {
	 ...
	 * elements = {c,a,b}, start=1, end=1 corresponds to the queue [a,b,c].
	 */
	...
	/**
	 * Returns {@code true} if the capacity limit of this queue has been
	 * reached, i.e. the number of elements stored in the queue equals its
	 * maximum size.
	 *
	 * @return {@code true} if the capacity limit has been reached,
	 ...
	 * recently added element is discarded so that a new element can be
	 * inserted.
	 *
	 * @param element
	 *        the element to add
