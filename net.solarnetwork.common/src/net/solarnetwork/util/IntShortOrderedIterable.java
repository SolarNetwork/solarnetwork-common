/* ==================================================================
 * IntIntOrderedIterable.java - 20/01/2020 3:55:44 pm
 * 
...
public interface IntShortOrderedIterable {
	 ...
	 * 
	 * @param action
	 *        the consumer to handle the (int, short) tuples
	 */
	 ...
	 * This method of iteration can be more efficient than iterating via the
	 * {@link java.util.Iterator} API because no unboxing of primitives is
	 * necessary. The meaning of how {@code min} and {@code max} are interpreted
	 * is implementation specific. For example, if the tuples in this collection
	 * represent key/value pairs, like a {@link java.util.Map}, they might refer
	 * to map keys and provide a way to iterate over a subset of the map's data.
	 * </p>
	 * 
	 * @param min
