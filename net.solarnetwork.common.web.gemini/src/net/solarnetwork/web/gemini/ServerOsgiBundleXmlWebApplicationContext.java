...
public class ServerOsgiBundleXmlWebApplicationContext extends OsgiBundleXmlApplicationContext
	...
	public ServerOsgiBundleXmlWebApplicationContext(String[] configLocations,
		...
		setDisplayName("Root ServerOsgiBundleXmlWebApplicationContext");
		logger.debug(
				"Creating an ServerOsgiBundleXmlWebApplicationContext with locations [{}] and parent [{}].",
	...
	public void setServletContext(final ServletContext servletContext) {
		...
		this.servletContextResourcePatternResolver = new ServletContextResourcePatternResolver(
				servletContext);
	...
	public BundleContext getBundleContext() {
		...
		if ( bundleContext == null ) {
			...
			if ( this.servletContext != null ) {
				Object bundleContextFromServletContext = this.servletContext
						.getAttribute(BUNDLE_CONTEXT_ATTRIBUTE);
			...
			if ( bundleContext == null ) {
				...
				if ( parent instanceof ConfigurableOsgiBundleApplicationContext ) {
					...
					bundleContext = ((ConfigurableOsgiBundleApplicationContext) parent)
							.getBundleContext();
					setBundleContext(bundleContext);
				}
			}
	...
	protected void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		...
		if ( bundleContext != null ) {
			...
			if ( sr != null ) {
				...
				try {
					...
					throw new ApplicationContextException("Kernel bean factory post processor failed",
							e);
				} finally {
		...
		beanFactory.addBeanPostProcessor(
				new ServletContextAwareProcessor(getServletContext(), getServletConfig()));
