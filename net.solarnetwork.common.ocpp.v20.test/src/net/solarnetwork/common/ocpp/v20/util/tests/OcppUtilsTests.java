...
package net.solarnetwork.common.ocpp.v20.util.tests;
...
import net.solarnetwork.common.ocpp.v20.util.OcppUtils;
import ocpp.domain.SchemaValidationException;
import ocpp.v20.ConnectorStatusEnum;
import ocpp.v20.StatusNotificationRequest;
