...
public class HeartbeatProcessor extends BaseActionMessageProcessor<HeartbeatRequest, HeartbeatResponse> {
	...
	@Override
	public void processActionMessage(final ActionMessage<HeartbeatRequest> message,
			final ActionMessageResultHandler<HeartbeatRequest, HeartbeatResponse> resultHandler) {
